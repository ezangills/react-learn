    ...
    return (
        <div>
            <Paper className={classes.root}>
                ...
                <div className={classes.flex}>
                    <TextField label='Write a message...' id="outlined-basic" variant="outlined" className={classes.chatBox} value={textValue} onChange={e => changeTextValue(e.target.value)} />
                    <Button 
                        variant="contained" 
                        color='primary'
